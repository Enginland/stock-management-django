...
SECRET_KEY = 'django-insecure-_$ec##_m2*$y-41$71jd5(l!l$2!41**5it8tm-uzeh7p-^4_%'
...
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Assuming BASE_DIR is defined at the start of your settings.py
]
TEMPLATES = [
    {
